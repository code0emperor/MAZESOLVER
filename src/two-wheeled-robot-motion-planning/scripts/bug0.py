    ...
    while not rospy.is_shutdown():
        ...
        if state_ == 0:
            ...
            if math.fabs(err_yaw) < (math.pi / 6) and \
               regions_['front'] > 1.5 and regions_['frontright'] > 1 and regions_['frontleft'] > 1:
                print 'less than 30'
                change_state(0)
            ...
            if err_yaw > 0 and \
               ...
               regions_['left'] > 1.5 and regions_['frontleft'] > 1:
            ...
            if err_yaw < 0 and \
               math.fabs(err_yaw) > (math.pi / 6) and \
               math.fabs(err_yaw) < (math.pi / 2) and \
               regions_['right'] > 1.5 and regions_['frontright'] > 1:
